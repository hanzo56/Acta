    ...
    <div className="acta-shell text-[#e5e2e1]">
        ...
        <div className="flex w-full max-w-[768px] flex-col items-center gap-8 py-6">
          <div className="flex w-full flex-col items-center gap-8">
            ...
            >
              {bars.map((b, i) => (
                <div
                  key={i}
                  className={`acta-wave-bar w-1.5 shrink-0 rounded-full ${b.bg} ${b.h}`}
                  style={{
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative flex items-center justify-center">
              <div
                className="acta-mic-pulse-ring pointer-events-none absolute aspect-square w-[140px] rounded-full border border-[rgba(78,222,163,0.35)]"
                aria-hidden
              />
              <div
                className="acta-mic-pulse-ring-delayed pointer-events-none absolute aspect-square w-[140px] rounded-full border border-[rgba(78,222,163,0.25)]"
                aria-hidden
              />
              <div className="acta-mic-button-glow relative flex items-center justify-center rounded-full bg-[rgba(78,222,163,0.2)] p-8 shadow-[0px_0px_40px_0px_rgba(78,222,163,0.3)]">
                ...
                <div className="relative h-[38px] w-7 shrink-0">
                  <img
                    alt=""
            ...
            <p className="acta-listening-text text-[12px] font-bold uppercase leading-4 tracking-[2.4px] text-[#4edea3]">
              LISTENING...
            </p>
          </div>
        </div>
      ...
      >
        <div className="relative h-20 w-full">
          <Link
            to="/"
            className="absolute left-[31px] top-1/2 flex -translate-y-1/2 flex-col items-center gap-1"
          >
          ...
          <Link
            to="/connectors"
            className="absolute left-[124px] top-1/2 flex -translate-y-1/2 flex-col items-center gap-1"
          >
          ...
          <Link
            to="/graph"
            className="absolute left-[214px] top-1/2 flex -translate-y-1/2 flex-col items-center gap-1"
          >
          ...
          <Link
            to="/connectors"
            className="absolute left-[311px] top-1/2 flex -translate-y-1/2 flex-col items-center gap-1"
          >
