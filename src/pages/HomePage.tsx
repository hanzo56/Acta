...
const PHONE_UPDATE_INTENT =
  /\b(?:give me a status update (?:on|of|about) my phone activit(?:y|ies|es)|give me an update (?:on|of|about) my phone activit(?:y|ies)|give me an update (?:on|of|about) my phone activity|give me (?:a )?status update(?: (?:on|of|for|about) (?:my )?phone(?: activit(?:y|ies|es)?)?)?|status update(?: (?:on|of|for|about) (?:my )?phone(?: activit(?:y|ies|es)?)?)?|what(?:'s| is| are)(?: going on with| happening with)? (?:my )?phone activit(?:y|ies|es)|about (?:my )?phone activit(?:y|ies|es)|(?:my |the )?phone activit(?:y|ies|es)|give me an update|give (?:me )?(?:an )?update|provide (?:me )?(?:with )?(?:an )?update|provide me an update (?:on|of|about) my phone activit(?:y|ies)|provide me a status update (?:on|of|about) my phone activit(?:y|ies|es)|an update (?:on|of|about) my phone activit(?:y|ies)|update (?:on|about|of) my phone(?: activit(?:y|ies))?|updates? (?:on|about|for|of) my phone|phone activit(?:y|ies) (?:update|summary)|summar(?:y|ize|ise) (?:of )?my phone|what(?:'s| is) (?:happening |going )?on my phone|any updates? (?:on|about|for) my phone|phone update|activity update|check my phone)\b/i;
